...
select nombre, apellido1, apellido2, "Cliente" as "Tipo"
from cliente left join pedido
on cliente.id = pedido.id_cliente
where pedido.id_cliente is null
...
select nombre, apellido1, apellido2, "Comercial" as "Tipo"
from comercial left join pedido
on comercial.id = pedido.id_comercial
where pedido.id_comercial is null
order by 2,3,1;
...
/* No, ya que las tablas no están enlazadas por columnas con el mismo nombre, por lo tanto no se podría*/